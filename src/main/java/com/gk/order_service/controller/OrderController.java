package com.gk.order_service.controller;
...
import com.gk.order_service.dto.OrderResponseDTO;
import com.gk.order_service.dto.ProductDTO;
import com.gk.order_service.entity.Order;
import com.gk.order_service.repository.OrderRepository;
	...
	public Mono<ResponseEntity<OrderResponseDTO>> placeOrder(@RequestBody Order order) {
	    ...
	    return webClientBuilder.build()
	            ...
	            .map(productDTO -> {
	                ...
	                // save order details (blocking call wrapped safely)
